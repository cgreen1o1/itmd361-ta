...
$('#home-aside1').append('<figure id="figure1-append"><img id="img1-append" src="media/hired-4-3.jpg" alt="Me as a Police Officer" /><button id="img1-button"><img id="img1-next" src="media/next.png" alt="Next Image" /></button></figure>');
$('#home-aside3-section').append('<figure id="figure5-append"><img id="img5-append" src="media/pi-by-numbers-4-3.jpg" alt="Anyone hungry for Pi?" /><button id="img5-button"><img id="img5-next" src="media/next.png" alt="Next Image" /></button></figure>');

$.noConflict();

(function($) {
  var mainImage = document.getElementById('img1-append');
  var imageArray = [
  ...
  var imageIndex = 0;
  var mainImage2 = document.getElementById('img5-append');
  var imageArray2 = [
  ...
  function changeImage() {
    if(responsiveFeature('image-slideshow')) {
      $('#figure1-append').show();
      $('.hide').hide();
      document.getElementById('img1-append').addEventListener('click', changeImage);
      ...
      $('#figure1-append').hide(); // hide the HTML
      $('.hide').show();
    }
  }
  //  function that cycles through images on click
  function changeImage2() {
    if(responsiveFeature('image-slideshow')) {
      $('#figure5-append').show();
      $('.hide').hide();
      document.getElementById('img5-append').addEventListener('click', changeImage2);
      ...
      $('#figure5-append').hide(); // hide the HTML
      $('.hide').show();
    }
  }

  $('#img1-button').on('click', changeImage);
  $('#img5-button').on('click', changeImage2);
