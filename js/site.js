...
$('#home-aside1').append('<figure id="figure1-append"><img id="img1-append" src="media/hired-4-3.jpg" alt="Me as a Police Officer" /></figure>');
$('#home-aside3-section').append('<figure id="figure5-append"><img id="img5-append" src="media/pi-by-numbers-4-3.jpg" alt="Anyone hungry for Pi?" /></figure>');
